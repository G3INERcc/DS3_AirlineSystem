...
$checkCode ="SELECT cod_airline FROM airline WHERE cod_airline='$code'";
...
// VALIDAR NOMBRE
$checkName ="SELECT name FROM airline WHERE name='$name'";

$resultName = $conn->query($checkName);
if ($resultName->num_rows > 0) {
    header("Location: " . $redirectError . "?error=name");
    exit();
}
// INSERTAR
$sql ="INSERT INTO airline (cod_airline, name, country) VALUES('$code','$name','$country')";
