...
if (
    ...
    $checkCode = "
        SELECT cod_airline
        FROM airline
        WHERE cod_airline='$newCode'
        AND cod_airline<>'$originalCode'
    ";
    ...
    $update = "
        ...
        SET
            ...
            name='$newName',
            country='$newCountry'
        WHERE cod_airline='$originalCode'
    ";
        ...
        <div class="search-container">
            ...
            <form method="GET" class="search-form">
                ...
                <button
                    type="button"
                    class="btn-search"
                    onclick="window.location.href='../html/createAirline.html'">
